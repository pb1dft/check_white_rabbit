...
def test_generic_status(monkeypatch, capsys, mode, oid, val, expected_code, expected_msg):  # noqa: E501
    # patch snmp_get
    monkeypatch.setattr(wr, 'snmp_get', mock_snmp_get({oid: val}))

    # patch sys.argv to simulate CLI arguments
    monkeypatch.setattr('sys.argv', ['check_white_rabbit', '-H', '127.0.0.1', '-m', mode])  # noqa: E501
